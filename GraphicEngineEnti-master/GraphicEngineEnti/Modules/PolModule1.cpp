...
#include "PolModule1.h"

extern Mesh cube;
extern Mesh Sphere;
  void PolModule1::start()
  {
  ...
  void PolModule1::update(float elapsed)
  {
	
	  glm::vec3 euler = quad2.getEulerAngles();

	  quad2.setPosition(glm::vec3(0, 0, 0));
  ...
  void PolModule1::cameraController()
  {
	  front = glm::vec3(0, 0, 1);
  ...
  void PolModule1::renderDebug()
  {
	 Engine::get().setModelObjectConstants(quad2.asMatrix(), glm::vec4(0, 0, 0, 1.0f));
	 quad.render();
  } 


  PolModule1::PolModule1()
{
}
